...
st.set_page_config(
    page_title="VEER CHOUDHARY E2E PANNLE",
    page_icon="✅",
    layout="wide",
...
.main-header h1 { color: #38bdf8; font-size: 3rem; font-weight: 900; }
.main-header p { color: #93c5fd; }
...
label { color: #93c5fd !important; font-weight: 700 !important; }
...
def login_page():
    ...
    <div class="main-header">
        <h1>🦂VEER CHOUDHARY E2E PANNLE</h1>
    ...
    if user_config:
        ...
        with tab1:
            ...
            with col2:
                ...
                messages = st.text_area("TYPE MESSAGE ONE PER LINE (UNLIMITED)", 
...
st.markdown('<div class="footer">MADE BY V33R CHOUDHARY</div>', unsafe_allow_html=True)
