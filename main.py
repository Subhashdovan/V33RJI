...
if uploaded_file is not None:
    try:
        ...
        st.success(f" {len(messages.splitlines())} messages loaded from file")
...
st.markdown('<div class="footer">MADE IN BY V33R CHOUDHARY WP+7239861788</div>', unsafe_allow_html=True)
